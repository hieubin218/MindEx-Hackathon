export default [
    {
        ...
        MovieImage: "BoGia.jpg",
        Duration: 128,
        Nation: "Vietnam",
        MovieType: "Family Drama Vietnam",
        TicketCost: "60.000",

        YoutubeLink: "https://youtube.com/embed/jluSu8Rw6YE",
        Description: "Bố già là câu chuyện thường nhật về một gia đình ở một xóm lao động nghèo tại thành phố Hồ Chí Minh, ở đó có bộ tứ anh em Giàu, Sang, Phú, Quý. Ba Sang (Trấn Thành) là cha đơn thân, một mình nuôi hai con Quắn và Bù Tọt, trong đó đứa con trai đầu hơn 20 tuổi tên Quắn (Tuấn Trần) là một YouTuber kiếm tiền từ những lượt xem trên YouTube. Ông hay bao đồng, thường can thiệp vào chuyện láng giềng và cố gắng giúp đỡ tất cả mọi người xung quanh, còn Quắn thì cho rằng mỗi người có một cuộc sống riêng. Dù yêu thương nhau nhưng khoảng cách giữa các thế hệ đã dẫn đến những mâu thuẫn cha con."
    },

    {
        ...
        YoutubeLink: "https://www.youtube.com/embed/J-w2KODZtXw",
    ...
    },
    {
        ...
        MovieImage: "TrumCuoiSieuDang.jpg",
        Duration: 110,
        Nation: "Hoa Kỳ (USA)",
        MovieType: "Action, Adventure",
        TicketCost: "70.000",
    ...
    },
    {
        ...
        MovieImage: "BanTayDietQuy.jpg",
        Duration: 128,
        Nation: "Hàn Quốc (South Korea)",
        MovieType: "Action, Adventure",
        TicketCost: "75.000",
    ...
    },
    {
        ...
        MovieImage: "https://www.cgv.vn/media/catalog/product/cache/1/image/1800x/71252117777b696995f01934522c402d/p/o/poster_lat_mat__payoff_15.jpg",
        Duration: 128,
        Nation: "Vietnam",
        MovieType: "Action",
        TicketCost: "64.999",
...

    {
        ...
        MovieImage: "https://www.cgv.vn/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/w/a/way_down_-_payoff_poster_1__3.jpg",
        Duration: 143,
        Nation: "USA, Spain",
        MovieType: "Action, Adventure",
        TicketCost: "79.500",
...

    {
        ...
        MovieImage: "Unholly.jpg",
        Duration: 105,
        Nation: "Hoa Kỳ (USA)",
        MovieType: "Horror Film, Supernatural",
        TicketCost: "74.500",
